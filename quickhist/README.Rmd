...
You can install the development version of quickhist from [GitHub](https://github.com/) with:
...
The function quick_hist() is meant to be used to create a histogram by specifying a variable to be plotted and the bin width.
